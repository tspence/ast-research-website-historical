...
'BEGIN MAIN SUB -----------------------------------
	...
	If (strAction = "BIOSTable") or (strAction = "BulletinPage") Then
		strButton = strAction
		...
		strBulletin = Trim(Request.QueryString("Bulletin"))
	End If
...
Public Sub Bulletinhtm()
%>
	<TABLE BORDER="0" ALIGN="DEFAULT" WIDTH="100%" BGCOLOR="WHITE">
	<TR><TD>
	<p>
	Before you download the selected file, you may wish to read more information about it.  For more information about the file, click on this link:
	</p>
	<P>
<%
	Response.Write "<A HREF=""/" & GetBulletinPath(strBulletin) & "/" & strBulletin & ".HTM"">" & strBulletin & "</A></TD>"
%>
	</p>
	</TD></TR>
	<TR><TD>
	<P></P>
	<p>
	Otherwise, click on the following link in order to begin downloading the desired file:
	</p>
	<p>
	<TABLE BORDER="0" ALIGN="DEFAULT" WIDTH="100%" BGCOLOR="WHITE">
	<TR><TD ALIGN="LEFT" VALIGN="TOP" WIDTH="30"></TD>
...
%>
	...
	<li>You can also view <strong><a href="fileg.htm">all the files</a></strong> in the index, or you can view the <strong><a href="Biostbls.htm">BIOS tables</a></strong> by part number.</li>
	...
	For ilist = ibegin To istop
		...
		If rProd("Bulletin") = "NA" Then
			If  rProd("Type") = "BIOS" Then
				Response.Write "<TD ALIGN=""LEFT"" VALIGN=""TOP"" WIDTH=""125""><A HREF=""/scripts/wfalt.asp?action=BIOSTable&path=" & rProd("Path") & "&name=" & rProd("Name") & "&description=" & rProd("Description") & "&size=" & rProd("Size") & """>" & rProd("Name") & "</A></TD>"
			Else
				Response.Write "<TD ALIGN=""LEFT"" VALIGN=""TOP"" WIDTH=""125""><A HREF=""ftp://ftp.ast.com/" & rProd("Path") & "/" & rProd("Name") & """>" & rProd("Name") & "</A></TD>"
			End If
		Else
			Response.Write "<TD ALIGN=""LEFT"" VALIGN=""TOP"" WIDTH=""125""><A HREF=""/scripts/wfalt.asp?action=BulletinPage&path=" & rProd("Path") & "&name=" & rProd("Name") & "&description=" & rProd("Description") & "&bulletin=" & rProd("Bulletin") & "&size=" & rProd("Size") & """>" & rProd("Name") & "</A></TD>"
		End If
...
Public Sub SelectQuery()
	...
	rProd.Open SQL, "DSN=Ebony_Tower;UID=ehoffman;PWD=***REDACTED***;DATABASE=Search", 3, 4
