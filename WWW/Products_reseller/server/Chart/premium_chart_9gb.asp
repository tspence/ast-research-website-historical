	...
	<TR>
		<TD><IMG SRC="../images/premiumhs_banner.GIF" WIDTH="387" HEIGHT="128" ALIGN="BOTTOM" BORDER="0"><BR>
			...
			<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="4" WIDTH="497">
				<TR>
					<TD HEIGHT="20" COLSPAN="4" BGCOLOR="#CD7407"><FONT COLOR="#FFFFFF"><B>HS-9GB</B></FONT></TD>
				</TR>
				<TR>
					<TD HEIGHT="20" VALIGN="TOP" BGCOLOR="#FFF5EC"><FONT SIZE="2"><B>Model</B></FONT></TD>
					<TD HEIGHT="20" ALIGN="LEFT" VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFFEE8"><FONT SIZE="2">503461-101, 503461-201 Windows&reg; NT</FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFFEE8"><FONT SIZE="2"><B><%=PartPrice("503461-101")%>,&nbsp&nbsp<%=PartPrice("503461-201")%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFFEE8"><FONT SIZE="2"><B><%=PartRebate("503461-101")%>,&nbsp&nbsp<%=PartRebate("503461-201")%></B></FONT></TD>
				</TR>

				<TR ALIGN="LEFT">
					<TD ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF5EC"><FONT SIZE="2">Demo Unit Purchase Price</FONT></TD>
					<TD ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFFEE8"><FONT SIZE="2"><B><%=RealPartPrice("503461-101", "C", 0.70)%>,&nbsp&nbsp<%=RealPartPrice("503461-201", "C", 0.70)%></B></FONT></TD>
				</TR>
				...
				<TR>
					...
					<TD ALIGN="LEFT" VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFFEE8"><FONT SIZE="2">9 GB Seagate Cheetah 10,000 RPM Ultra Wide SCSI drives&nbsp;</FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD HEIGHT="16" VALIGN="TOP" BGCOLOR="#FFF5EC"><FONT SIZE="2">Form Factor</FONT></TD>
					<TD HEIGHT="16" VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFFEE8"><FONT SIZE="2">NLX Form Factor System Board19&quot; rack mountable system enclosure</FONT></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
