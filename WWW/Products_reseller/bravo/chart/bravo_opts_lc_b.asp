		...
		<TD>&nbsp;<IMG SRC="../images/bravo_options.GIF" WIDTH="387" HEIGHT="128" ALIGN="BOTTOM" BORDER="0" NATURALSIZEFLAG="3"><BR>
			...
			<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="3" WIDTH="497">
				...
				<TR>
					...
					<TD COLSPAN="2" BGCOLOR="#FFF7EF"><FONT SIZE="2">1749, 1798</FONT></TD>
				</TR>
				<TR BGCOLOR="#FFCC00">
					<TD COLSPAN="3" BGCOLOR="#790F00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FONT COLOR="#FFFFFF"><B>Memory Expansion</B></FONT></TD>
				</TR>
				<TR>
					<TD HEIGHT="20" BGCOLOR="#FBF1F0"><FONT SIZE="2">8 MB JEDEC (Two 4 MB non-parity SIMMs, 70ns)</FONT></TD>
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2">500987-003</FONT></TD>
					<TD BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("500987-003", empcheck) %></FONT></TD>
				</TR>
				<TR BGCOLOR="#C0C0C0">
					<TD HEIGHT="20" BGCOLOR="#FBF1F0"><FONT SIZE="2">16 MB JEDEC (Two 8 MB non-parity SIMMs, 70ns)</FONT></TD>
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2">501340-002</FONT></TD>
					<TD BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("501340-002", empcheck) %></FONT></TD>
				</TR>
				<TR>
					<TD HEIGHT="20" BGCOLOR="#FBF1F0"><FONT SIZE="2">32 MB JEDEC (Two 16 MB non-parity SIMMs, 70ns)</FONT></TD>
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2">500987-005</FONT></TD>
					<TD BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("500987-005", empcheck) %></FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD HEIGHT="20" BGCOLOR="#FBF1F0"><FONT SIZE="2">Audio Card w/QSound 3D Effect</FONT></TD>
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2">503434-001</FONT></TD>
