...
<TABLE BORDER="0" CELLPADDING="10" CELLSPACING="0" WIDTH="570">
	<TR>
		<TD WIDTH="696%" VALIGN="TOP"><IMG SRC="../images/ms_5200.GIF" WIDTH="387" HEIGHT="128" ALIGN="BOTTOM" BORDER="0" NATURALSIZEFLAG="3"><BR>
<BR>
&nbsp;<BR>
<BR>
<B><I>Bravo MS 5200 Windows NT systems &amp; Windows 95 systems </I></B><BR>
			
			<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="4" WIDTH="497">
				<TR ALIGN="LEFT">
					<TD HEIGHT="20" ALIGN="LEFT" VALIGN="TOP" COLSPAN="4" BGCOLOR="#790F00">&nbsp;<FONT COLOR="#FFFFFF"><B>3000C&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NT / 95</B></FONT></TD>
				</TR>
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF4F2">
						<P ALIGN="LEFT"><FONT SIZE="2">Model</FONT>
					</TH>
					<TD ALIGN="LEFT" VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000">#503</FONT><FONT SIZE="2">251-301 ('95), -401 (NT)</FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=PartPrice("503251-301")%>,&nbsp&nbsp<%=PartPrice("503251-401")%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=PartRebate("503251-301")%>,&nbsp&nbsp<%=PartRebate("503251-401")%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=RealPartPrice("503251-301", "C", 0.85)%>,&nbsp&nbsp<%=RealPartPrice("503251-401", "C", 0.85)%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2">Pentium&reg; 200Mhz</FONT></TD>
				</TR>
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF4F2">
				...
				<TR ALIGN="LEFT">
					...
					<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2">3 GB</FONT></TD>
				</TR>
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF4F2">
						<P ALIGN="LEFT"><FONT SIZE="2" COLOR="#000000">Synchronous Graphics RAM</FONT>
					</TH>
					<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2">2 MB (6 MB max)</FONT></TD>
				</TR>
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF4F2">
						<P ALIGN="LEFT"><FONT SIZE="2" COLOR="#000000">CD-ROM</FONT>
					</TH>
					<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2">16x max</FONT></TD>
				</TR>
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF4F2">
				...
				<TR ALIGN="LEFT">
					...
					<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFF7EF"><FONT SIZE="2">MiniTower</FONT></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
