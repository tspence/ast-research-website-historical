...
<B><I>Windows NT systems &amp;  Windows 95 systems</I></B><BR>
			...
			<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="4" WIDTH="497">
				<TR ALIGN="LEFT">
					<TH ALIGN="LEFT" VALIGN="TOP" COLSPAN="2" BGCOLOR="#790F00">
						<P ALIGN="LEFT"><FONT COLOR="#FFFFFF">2000C&nbsp;&nbsp;&nbsp;NT/95</FONT>
					</TH>
				</TR>
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" VALIGN="TOP" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000">#503</FONT><FONT SIZE="2">248-501 (NT), -101 (95)</FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=PartPrice("503248-501")%>,&nbsp&nbsp<%=PartPrice("503248-101")%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=PartRebate("503248-501")%>,&nbsp&nbsp<%=PartRebate("503248-101")%></B></FONT></TD>
				</TR>
				...
				<TR ALIGN="LEFT">
					...
					<TD ALIGN="LEFT" BGCOLOR="#FFF7EF"><FONT SIZE="2" COLOR="#000000"><B><%=RealPartPrice("503248-501", "C", 0.85)%>,&nbsp&nbsp<%=RealPartPrice("503248-101", "C", 0.85)%></B></FONT></TD>
				</TR>
