	...
	<TR>
		<TD>&nbsp;<IMG SRC="../images/bravo_options.GIF" WIDTH="387" HEIGHT="128" ALIGN="BOTTOM" BORDER="0" NATURALSIZEFLAG="3"><BR>
			...
			<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="4" WIDTH="497">
				...
				<TR BGCOLOR="#000000">
					<TH HEIGHT="32" BGCOLOR="#FBF1F0">
						<P ALIGN="LEFT"><FONT COLOR="#000000">Option</FONT>
					</TH>
					<TH HEIGHT="32" BGCOLOR="#790F00"><FONT COLOR="#FFFFFF">Part Number</FONT></TH>
					<TH HEIGHT="32" BGCOLOR="#790F00"><FONT COLOR="#FFFFFF">
					<% if empcheck = 0 then %>
				...
				<TR>
					...
					<TD HEIGHT="16" COLSPAN="2" BGCOLOR="#FFF7EF"><FONT SIZE="2">1815, 1814, 1774, 1754, 1534, 1772, 1701</FONT></TD>
				</TR>
				<TR BGCOLOR="#FFCC00">
				...
				<TR>
					...
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("500987-003", empcheck) %></FONT></TD>
				</TR>
				<TR BGCOLOR="#C0C0C0">
					...
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("501340-002", empcheck) %></FONT></TD>
				</TR>
				<TR>
					...
					<TD HEIGHT="20" BGCOLOR="#FFF7EF"><FONT SIZE="2"><%call showprice("500987-005", empcheck) %></FONT></TD>
				</TR>
				<TR>
