...
SQL="BEGIN TRAN SELECT Description FROM parts WHERE pn='"+PN+"' COMMIT TRAN"
...
While Not RS.EOF
	...
	Else
		Response.Write "<i>"+RS("Title")+":</i> <a href='http://165.164.20.31/blender/" +RS("Path")+ "'>" +RS("Data")+ "</a><br>"
	End If
	RS.MoveNext
Wend
%>
