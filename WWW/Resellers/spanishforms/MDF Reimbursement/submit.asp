...
header = header + "MDF Reimbursement Program Form.  Please see Webster to view submission." + newline + newline
header = header + "= = = = = = = = = =" + newline + newline
call SendMail("jose.betances@ast.com", "interchange@ast.com", "MDF Reimbursement Program Form (Latin American Site)", header + text, 1, "")
call SendMail("interchange@ast.com", "interchange@ast.com", "(SAVE)MDF Reimbursement Program Form (Latin American Site)", header + text, 1, "")
%>
</BODY>
</HTML>
