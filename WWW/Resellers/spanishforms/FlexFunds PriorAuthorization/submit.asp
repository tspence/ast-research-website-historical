...
header = header + "FlexFund Prior Authorization Request Form.  Please see Webster to view submission." + newline + newline
header = header + "= = = = = = = = = =" + newline + newline

call SendMail("jose.betances@ast.com", "interchange@ast.com", "FlexFund Prior Authorization Request Form (Latin American Site)", header + text, 1, "")
call SendMail("interchange@ast.com", "interchange@ast.com", "(SAVE)FlexFund Prior Authorization Request Form (Latin American Site)", header + text, 1, "")
