...
header = header + "Flexfund Reimbursement Form.  Please see Webster to view submission." + newline + newline
header = header + "= = = = = = = = = =" + newline + newline
call SendMail("jose.betances@ast.com", "interchange@ast.com", "FlexFund Reimbursement Form (Latin American Site)", header + text, 1, "")
call SendMail("interchange@ast.com", "interchange@ast.com", "(SAVE)FlexFund Reimbursement Form (Latin American Site)", header + text, 1, "")
%>
