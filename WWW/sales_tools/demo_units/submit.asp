...
<P>Your information has been forwarded to our demo unit program manager.</P>
...
header =          "This is an automatically generated submission from the Demo Unit" + newline
...
call SendMail("kim.creech@ast.com", "ovation@ast.com", "Demo Unit Purchase Form", header + text, 1, "")
call SendMail("ovation@ast.com", "ovation@ast.com", "(SAVE) Demo Unit Purchase Form", header + text, 1, "")
