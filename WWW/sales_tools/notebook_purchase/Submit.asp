...
<P>Your information has been forwarded to our Notebook Purchase program manager.</P>
...
header =          "This is an automatically generated submission from the Notebook" + newline
header = header + "Purchase Program web page." + newline + newline
...
call SendMail("kim.creech@ast.com", "ovation@ast.com", "Notebook Purchase Form", header + text, 1, "")
call SendMail("ovation@ast.com", "ovation@ast.com", "(SAVE) Notebook Purchase Form", header + text, 1, "")
