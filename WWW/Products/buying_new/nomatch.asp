...
<HTML>
  <BODY BGCOLOR="#FFFFFF" LINK="#00698C" VLINK="#3A4D52" ALINK="#FFA600">
    ...
    <P>We're sorry, we did not recognize your zip code '<%=Request("zipcode")%>'.  By any 
    chance, did you mistype this field?</P>
    
    <P>Without a zip code, we are unable to match you with a potential reseller.</P>
