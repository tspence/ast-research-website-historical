...
if len(Trim(Request("name"))) = 0 then bad = 1
...
'************** Make sure the quantity field makes sense
quantity = cint(Request("quantity"))
if IsEmpty(quantity) then
  Response.Redirect("incomplete.asp?field=3")
end if
...
if len(trim(Request("ascentia"))) > 0 then
  Inquiry = Request("ascentia")
  Ascentia = "Y"
end if

if len(trim(Request("bravo"))) > 0 then
  Inquiry = Request("bravo")
  Bravo = "Y"
end if

if len(trim(Request("premium"))) > 0 then
  Inquiry = Request("premium")
  Manhattan = "Y"
end if

if ascentia = "N" and bravo = "N" and manhattan = "N" then
  Response.Redirect("incomplete.asp?field=1")
end if
